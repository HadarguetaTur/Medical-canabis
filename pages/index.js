...
export default function LandingPage() {
  ...
  return (
    <div>
      <Head>
        <meta property="og:title" content="יוליה סעד" />
        <meta property="og:description" content="יעוץ ליווי והדרכה הוליסטית" />
        <meta property="og:image" content="https://yulia-canabis.netlify.app/cover.png" />
        <meta property="og:url" content="https://yulia-canabis.netlify.app/" />
      </Head>
      <Navbar />
      <Header />
      <About />
